...
// 1. Next.js 15 Fix: Wrap params in a Promise
...
// 2. Next.js 15 Fix: Make the component async
export default async function AssignmentPage({ params }: AssignmentPageProps) {
  // 3. Next.js 15 Fix: Await the params before reading assignmentId
  const resolvedParams = await params;
  const assignment = assignmentsById[resolvedParams.assignmentId];
