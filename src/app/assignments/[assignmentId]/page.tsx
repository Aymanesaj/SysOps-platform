        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6">
          ...
          <div className="mt-5 overflow-hidden rounded-xl border border-slate-800 bg-[#0b1220]">
            <div className="flex items-center gap-2 border-b border-slate-800 px-4 py-2">
              ...
              <span className="ml-2 text-xs text-slate-500">mission-brief.md</span>
            </div>
        ...
        <aside className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5 lg:sticky lg:top-24 lg:h-fit">
          ...
          <div className="mt-5 space-y-5">
            <div>
              ...
              <p className="mt-1 inline-flex items-center gap-2 text-lg font-semibold text-indigo-200">
              ...
              <div className="mt-2 rounded-lg border border-slate-800 bg-slate-950/70 p-3">
                ...
                <div className="mt-3 flex gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 rounded-md border border-slate-700 px-2.5 py-1.5 text-xs text-slate-300 transition hover:border-emerald-400/60"
                  >
